...
df_2024.to_csv("../csv_predicated_model/sampled_hdb_2024_predictions_KNN_GridSearch.csv", index=False)
...
evaluate_and_save_model("KNN with GridSearch", y_test, y_pred)