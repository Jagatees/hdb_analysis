...
# Scale features using RobustScaler to mitigate the effect of outliers
scaler = RobustScaler()
...
# Define the parameters for xgb.train
params = {
...
# Use the best number of trees if available, else use the full model
