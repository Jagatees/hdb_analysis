...
df_2024.to_csv("../csv_predicated_model/DecisionTree.csv", index=False)
print("Predicted resale prices for 2024 saved to DecisionTree.csv")


# Save model performance metrics to a CSV file
performance_data = {
    "Metric": ["Model","R²", "RMSE", "MSE", "MAE", "Loss Percentage"],
    "Value": ["Decision Tree ",r2, rmse, mse, mae, loss_percentage]
}
